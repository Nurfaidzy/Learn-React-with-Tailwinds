        ...
        <div className="my-[-60%] text-white absolute md:px-[10%] px-[2%]">
          <div className="  text-center mix-blend-normal ">
            ...
            <p className="lg:text-2xl text-sm lg:px-0  px-12">
              ...
              soluta temporibus. Non fuga officia nam vero? Nemo ex labore
              aperiam totam dignissimos numquam voluptatum eaque provident
              tempora iusto, omnis est?
            </p>

            <div className="lg:py-[100px] md:py-0 lg:flex h-[100%] ">
              <div>
